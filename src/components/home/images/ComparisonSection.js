...
import 'src/components/home/ComparisonSection.css';
...
const ComparisonSection = () => {
  ...
  const [activeTab, setActiveTab] = useState('overview'); // For tab selection
  ...
  // Key highlights for the overview tab
  const highlights = [
  ...
  const getComparisonClass = (value, otherValues, metric) => {
    ...
    if (metric.id === 'application') {
      ...
      if (value === 'HIGH') {
        return 'comparison-section__value--good';
      } else if (value === 'MODERATE') {
        return 'comparison-section__value--medium';
      } else {
  ...
  return (
    ...
    //     <h2 className="comparison-section__title">Compare Preservation Methods</h2>
          ...
          <div className="comparison-section__content-card">
            ...
            <div className="comparison-section__tabs">
              <button
                ...
                className={`comparison-section__tab-button ${activeTab === 'overview' ? 'active' : ''}`}
              ...
              <button
                ...
                className={`comparison-section__tab-button ${activeTab === 'produce' ? 'active' : ''}`}
                aria-selected={activeTab === 'produce'}
                role="tab"
              >
                Produce Comparison
              </button>
